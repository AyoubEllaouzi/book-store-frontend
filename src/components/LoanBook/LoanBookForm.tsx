...
export default function LoanBookForm({ users, books }: LoanBookFormProps) {
    ...
    }; // Define the handleCheckboxChange function here
            ...
            <form onSubmit={handleSubmit} className="p-3 border rounded">
                <div className="mb-3">
                    ...
                    <select
                        ...
                        onChange={(e) => handleUserSelect(users.find(user => user.id === parseInt(e.target.value)) || null)}
                    >
                ...
                <div className="mb-3">
                    ...
                    <select
                        className="form-select"
                        onChange={(e) => handleBookSelect(books.find(book => book.id === parseInt(e.target.value)) || null)}
                    >
